...
The 24 hour schedule can be input with priority 0 (denoting lower likelihood of observation).
...
Observations in the \texttt{nextVisit} would be marked with priority 2.
