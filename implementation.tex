...
The 24 hour schedule may be access at USDF by a call to an API in rubin-sim 2.2.2+ \\
{\texttt sim\_archive.fetch\_obsloctap\_visits(nights=2)}.
This result can be processed and entries with priority 2 put itn eh obslan table.
It should be robust against a second call so shouls always try to update or delete overlapping times.
